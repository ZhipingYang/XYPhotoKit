...
@interface CKPhotoPreviewViewController ()<PHPhotoLibraryChangeObserver, CKHorizontalScrollViewDelegate, CKHorizontalScrollViewDataSource, CKPhotoPreviewOverlayViewDelegate, CKPhotoHorizontalScrollItemViewDelegate>
{
...
- (void)loadView
{
	...
	_scrollView = [[CKHorizontalScrollView alloc] initWithFrame:CGRectMake(-5, 0, self.view.frame.size.width+10, self.view.frame.size.height)];
