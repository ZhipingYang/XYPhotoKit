...
@protocol XYPhotoSelectedAssetManagerDelegate<NSObject>
- (void)doneSelectingAssets;
@end

@interface XYPhotoSelectedAssetManager : NSObject
...
/**
 代理回调，结束asset选择
 */
@property (nonatomic, weak, nullable) id<XYPhotoSelectedAssetManagerDelegate> delegate;
