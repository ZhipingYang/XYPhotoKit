...
@interface CKPhotoCollectionDataSource () <PHPhotoLibraryChangeObserver, UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation CKPhotoCollectionDataSource

static NSString *const CKPhotoCollectionDataSourceCellReuseIdentifier = @"CKPhotoCollectionDataSourceCellReuseIdentifier";
...
- (instancetype)initWithCollectionView:(UICollectionView *)collectionView fetchResult:(PHFetchResult *)fetchResult
{
    if (self = [super init]) {
		...
		[_collectionView registerClass:[CKPhotoCollectionViewCell class] forCellWithReuseIdentifier:CKPhotoCollectionDataSourceCellReuseIdentifier];
...
{
    CKPhotoCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CKPhotoCollectionDataSourceCellReuseIdentifier forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if (isSingleSelected && [[CKPhotoSelectedAssetManager sharedManager].delegate respondsToSelector:@selector(doneSelectingAssets)]) {
		if ([[CKPhotoSelectedAssetManager sharedManager] addSelectedAsset:self.results[indexPath.row]]) {
