//
//  XYPhotoSelectedAssetPreviewView.h
//  XYPhotoKitDemo
//
...
@class XYPhotoSelectedAssetPreviewView;

@protocol XYPhotoSelectedAssetPreviewViewDelegate  <NSObject>
...
@interface XYPhotoSelectedAssetPreviewView : UIView

/**
 已选择的asset数组，并reload collectionView，监听系统的添加删除已选择的asset并做修改
 default: [XYPhotoSelectedAssetManager sharedManager].selectedAssets
 */
@property (nonatomic, strong) NSArray <PHAsset *> *assetArray;
@property (nonatomic, weak) id<XYPhotoSelectedAssetPreviewViewDelegate> delegate;
