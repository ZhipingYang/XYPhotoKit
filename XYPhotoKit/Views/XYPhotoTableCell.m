...
NSString *const XYPhotoTableCellReuseIdentifier = @"XYPhotoTableCellReuseIdentifier";

@interface XYPhotoTableCell ()
...
@implementation XYPhotoTableCell
...
- (void)setCollection:(PHAssetCollection *)collection
{
	...
	PHAssetMediaType type = [XYPhotoSelectedAssetManager sharedManager].mediaType;
